...
The website for La Mirage Apartments, 610 E Gilbert Dr, Tempe, AZ.
...
| `sitemap.xml`, `robots.txt`            | Tell Google which pages exist. Add a line to the sitemap if a page is added. |
| `photos/`                              | All pictures, sized for web.   |
